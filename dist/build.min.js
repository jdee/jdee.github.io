...
da("String.prototype.includes",function(a){return a?a:function(a,c){return-1!==aa(this,a,"includes").indexOf(a,c||0)}});da("Number.isFinite",function(a){return a?a:function(a){return"number"!==typeof a?!1:!isNaN(a)&&Infinity!==a&&-Infinity!==a}});da("Number.isInteger",function(a){return a?a:function(a){return Number.isFinite(a)?a===Math.floor(a):!1}});
...
function ya(a,b){var c=document.createElement("a");c.href=a;var d=c.origin;d.endsWith("/")&&(d=d.substring(0,d.length-1));if(!["https://api2.branch.io","https://app.link","https://bnc.lt"].includes(d))return!1;c=c.pathname;"/"!=c[0]&&(c="/"+c);d=c.split("/");if(3==d.length&&"c"===d[1])return!1;c=wa[c];if(!c)return!0;if(0<Object.keys(c).length){if(!b)return!0;for(var e in c)if(d=new RegExp(c[e]),!b.hasOwnProperty(e)||!d.test(b[e]))return!0}return!1}
...
d.s)),null);if(0===d.o||!d.o)return g(Error(w("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Z(){if(!(this instanceof Z))return gd||(gd=new Z),gd;this.ba=na();this.c=new Hb(["session","cookie","pojo"]);this.V=new Pb;this.h=[];this.X="web2.57.0";this.l=this.o=0;this.s=null}
...
r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;xa=!1;v&&Ba(g);b=M(g.c,!0);g.j=b&&b.identity_id;b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Oa("_branch_match_id")||Ia(),t=!g.j;g.C=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Oa("branchify_url"))Nb(g.c,{data:""}),Nb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.57.0",branch_key:g.i};var x=M(g.c,!0)||{};x.browser_fingerprint_id&&(b._t=
