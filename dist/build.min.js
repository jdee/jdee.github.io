...
"kindle":!1}function Ma(){var a=navigator.userAgent;return Ka(a)?La(a,11):!1}function Na(a){try{var b=(x()&&Ja()?window.top.location.search:window.location.search).substring(1).match(new RegExp(a+"=([^&]*)"));if(b&&1<=b.length)return b[1]}catch(c){}}function Pa(a){return a.replace(/(\-\w)/g,function(a){return a[1].toUpperCase()})}
...
function Vb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.Y?Tb(a,n,c,b.method,k):Ub(a,n,m,b.method,d,k)}function k(a,b,c){a&&0<t&&"5"===(c||"").toString().substring(0,1)?(t--,window.setTimeout(function(){f()},qa)):e(a,b)}ta="/v1/pageview"===b.endpoint&&c&&c.journey_displayed?b.endpoint+"-1-brtt":b.endpoint+"-brtt";("/v1/url"===b.endpoint||"/v1/has-app"===b.endpoint)&&1<Object.keys(u).length&&(delete u["-brtt"],c.instrumentation=q(A({},u)),u={});if(v)for(var l=["browser_fingerprint_id","alternative_browser_fingerprint_id",
"identity_id","session_id"],g=0;g<l.length;g++)c.hasOwnProperty(l[g])&&delete c[l[g]];l=Rb(a,b,c);if(l.error)return e(Error(q({message:l.error,endpoint:b.endpoint,data:c})));var n,m="";"GET"===b.method?n=l.url+"?"+l.data:(n=l.url,m=l.data);var t=pa;if(v&&ya(n,c))return xa?k(Error("Requested operation cannot be completed since tracking is disabled"),null,300):k(null,{},200);f()};function N(a){a&&a.parentNode.removeChild(a)}function Wb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function Xb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function Yb(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
function Qc(a,b,c,d,e,f,k,l){var g=k?0:Mc(f);O(S,a,T);Bc=!0;Oc(c);if(!k)if(void 0!==g&&b.set("globalJourneysDismiss",g,!0),Rc(b,d,e),f.dismissRedirect)window.location=f.dismissRedirect;else{var n=function(){S.removeListener(n);var b=Tc(l,va[a]);S.b(Eb,b,function(a,c){!a&&"object"===typeof c&&c.template&&l.N(c,null,!1)&&l.J(c.template,b,b.branch_view_id||c.event_data.branch_view_data.id,c.event_data.branch_view_data,!1,c.journey_link_data)})};S.addListener("branch_internal_event_didCloseJourney",n)}}
...
U.J=function(a,b,c,d,e,f){hc=c;Vc(f);var k=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);f=document.createElement("div");f.id="branch-banner";document.body.insertBefore(f,null);Wb(f,"branch-banner-is-active");var l=!1,g=b.callback_string,n=null,m=null,t=S.c;if(a){var z=Fc(a)||{},Oa=window.setTimeout(function(){window[g]=function(){}},ra);window[g]=function(a){window.clearTimeout(Oa);l||(m=a,Nc(c,k,t,m,n,z,e))};xc=n=Wc(a,b.has_app_websdk);if(null===
...
c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?!0:!1;xa=!1;v&&Ba(g);b=M(g.c);var n=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=n||Na("_branch_match_id")||Ia(),t=!b||!b.identity_id;g.B=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Na("branchify_url"))Nb(g.c,{data:""}),Nb(g.c,{referring_link:""}),d(),k(e);else{b={sdk:"2.54.4",branch_key:g.i};var z=M(g.c,!0)||{};z.browser_fingerprint_id&&(b._t=z.browser_fingerprint_id);z.identity&&
(g.g=z.identity);var Oa=parseInt(Na("[?&]_open_delay_ms"),10);Ma()?g.b(jb,{link_identifier:m,browser_fingerprint_id:m||z.browser_fingerprint_id,alternative_browser_fingerprint_id:z.browser_fingerprint_id,options:c,initial_referrer:gb(V(g)),current_url:x()&&Ja()?window.top.location.href:window.location.href,screen_height:screen.height||0,screen_width:screen.width||0},function(a,b){a&&(g.j=2,g.m=a.message);a||"object"!==typeof b||(b.branch_view_enabled&&(g.B=!!b.branch_view_enabled,g.c.set("branch_view_enabled",
